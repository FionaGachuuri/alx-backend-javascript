 ...
 * @returns {Promise<String>} - A promise that resolves to a formatted string report.
 */
...
/**
 * Array of route handlers for the HTTP server.
 * Each handler defines a route and the logic to respond to it.
 */
...
/**
 * Main request listener for the HTTP server.
 * It dispatches incoming requests to the appropriate route handler.
 */
...
app.listen(PORT, HOST, () => {
  ...
  if (DB_FILE) {
    ...
    console.log('No database file provided.');
  }
}
);
